...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $conn->close();
    header('Content-Type: application/json'); // Asegúrate de establecer el tipo de contenido a JSON
    echo json_encode($cursos); // Devuelve los cursos en formato JSON
    exit; // Asegúrate de salir después de manejar la solicitud GET
}
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    ...
    function updateCourse() {
        const courseId = courses[currentEditIndex].id;
        const formData = new FormData();
        formData.append('update', true);
        formData.append('course_id', courseId);
        formData.append('name', document.getElementById('course-name').value);
        formData.append('descriptiom', document.getElementById('course-descriptiom').value);
        formData.append('image_url', document.getElementById('course-image-url').value);
